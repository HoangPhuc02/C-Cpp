 ...
 *
 * It also reads data from UART2 directly, and echoes it to console.
 *
 * - Port: UART2
...
static void uart_event_task(void *pvParameters)
{
    ...
    for(;;) {
        ...
        if(xQueueReceive(uart2_queue, (void * )&event, (TickType_t)portMAX_DELAY)) {
            ...
            //bzero like memset which can set a block data to 0
...
void app_main(void)
{
    ...
    xTaskCreatePinnedToCore(blink_led, "blink_led", 2048, NULL, 12, NULL,0);
}
